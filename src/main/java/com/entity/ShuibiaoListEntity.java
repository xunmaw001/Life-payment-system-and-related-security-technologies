...
public class ShuibiaoListEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ShuibiaoListEntity() {

	}

	public ShuibiaoListEntity(T t) {
		try {
    ...
    public String toString() {
        return "ShuibiaoList{" +
            ...
            ", shuibiaoListOldMoney=" + shuibiaoListOldMoney +
            ", shuibiaoListNewMoney=" + shuibiaoListNewMoney +
