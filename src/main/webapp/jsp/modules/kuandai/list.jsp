...
<body>
    ...
    <div class="modal fade" id="kuandaiListModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <%-- 模态框标题--%>
                <div class="modal-header">
                    <h5 class="modal-title" id="kuandaiListModalTitle">列表</h5>
                ...
                <div class="modal-body">
                    <div class="col-sm-12">
                        ...
                        <%-- 详情表 --%>
                        <input type="hidden" id="kuandaiListFlag">
                        <label class="col-sm-1">
                            <button onclick="addKuandaiList()" type="button" class="btn btn-success 新增">添加</button>
                        </label>
                    </div>
                    <%-- 列表 --%>
                    <table id="kuandaiTable" class="table table-bordered table-striped">
                        <thead>
                        <tr>
                            <th >缴费前余额</th>
                            <th >缴费金额(元)</th>
                        ...
                        <tbody id="kuandaiListTableTbody">
                        </tbody>
                    </table>
                </div>
                <%-- 模态框按钮 --%>
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="submitKuandaiList()" class="btn btn-primary">提交</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <%--  列表查看 --%>
    <div class="modal fade" id="showKuandaiListModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <%-- 模态框标题--%>
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <%--<div class="col-sm-12">
                        &lt;%&ndash; 当前表 &ndash;%&gt;
                        <label class="col-sm-1">
                            <button onclick="addShowKuandaiList()" type="button" class="btn btn-success 新增">添加</button>
                        </label>
                    </div>--%>
                    <table id="inOutTableList" class="table table-bordered table-striped">
                        ...
                        <tbody id="showKuandaiListTableTbody">
                        </tbody>
                    </table>
                </div>
                <%-- 模态框按钮 --%>
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">宽带管理</li>
                            <li class="breadcrumb-item active">宽带列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        宽带编号
                                        <div class="layui-input-inline">
                                            <input type="text" id="kuandaiNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="宽带编号" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        宽带余额
                                        <div class="layui-input-inline">
                                            <input type="text" id="kuandaiMoneyStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="kuandaiMoneyChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="kuandaiMoneyEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="kuandaiMoneyChickValue(this)"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        宽带编号所在地址
                                        <div class="layui-input-inline">
                                            <input type="text" id="kuandaiAddressSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="宽带编号所在地址" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                                        ...
                                        <%--<button onclick="outKuandaiList()" type="button" class="btn btn-success 新增">出出出出出出出出出出出出出出出</button>--%>
...
// 当前表关联
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //宽带编号
            var kuandaiNumberSearchInput = $('#kuandaiNumberSearch');
            if( kuandaiNumberSearchInput != null){
                if (kuandaiNumberSearchInput.val() != null && kuandaiNumberSearchInput.val() != '') {
                    searchForm.kuandaiNumber = $('#kuandaiNumberSearch').val();
                }
            }
     
            //宽带余额
            var kuandaiMoneyStartSearchInput = $('#kuandaiMoneyStartSearch');
            if(kuandaiMoneyStartSearchInput != null){
                var kuandaiMoneyStartSearchValue = kuandaiMoneyStartSearchInput.val();
                if( kuandaiMoneyStartSearchValue  != 0){
                    searchForm.kuandaiMoneyStart = kuandaiMoneyStartSearchValue;
                }
            }
            var kuandaiMoneyEndSearchInput = $('#kuandaiMoneyEndSearch');
            if(kuandaiMoneyEndSearchInput != null){
                var kuandaiMoneyEndSearchValue = kuandaiMoneyEndSearchInput.val();
                if( kuandaiMoneyEndSearchValue  != 0){
                    searchForm.kuandaiMoneyEnd = kuandaiMoneyEndSearchValue;
                }
            }
     
            //宽带编号所在地址
            var kuandaiAddressSearchInput = $('#kuandaiAddressSearch');
            if( kuandaiAddressSearchInput != null){
                if (kuandaiAddressSearchInput.val() != null && kuandaiAddressSearchInput.val() != '') {
                    searchForm.kuandaiAddress = $('#kuandaiAddressSearch').val();
                }
            }
                getDataList();
        }
        ...
        function getDataList() {
            http("kuandai/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                //本表的
                kuandaiNumber: searchForm.kuandaiNumber,
                kuandaiMoneyStart: searchForm.kuandaiMoneyStart,
                kuandaiMoneyEnd: searchForm.kuandaiMoneyEnd,
                kuandaiAddress: searchForm.kuandaiAddress,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //宽带编号
            var kuandaiNumberCell = document.createElement('td');
            kuandaiNumberCell.innerHTML = item.kuandaiNumber;
            row.appendChild(kuandaiNumberCell);


            //宽带余额
            var kuandaiMoneyCell = document.createElement('td');
            kuandaiMoneyCell.innerHTML = item.kuandaiMoney;
            row.appendChild(kuandaiMoneyCell);


            //宽带编号所在地址
            var kuandaiAddressCell = document.createElement('td');
            kuandaiAddressCell.innerHTML = item.kuandaiAddress;
            row.appendChild(kuandaiAddressCell);
            ...
            // 小数
            function kuandaiMoneyChickValue(e){
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("kuandai/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addkuandai", "addkuandai");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //查询当前表搜索条件所有列表
        ...
        //出出出出出出出出出出出出出出出
        function outKuandaiList() {
            document.getElementById("kuandaiListModalTitle").innerHTML = "出出出出出出出出出出出出出出出列表";
            $("#kuandaiListFlag").val(2);
            $('#kuandaiListModal').modal('show');
        }
        //入入入入入入入入入入入入入入入
        function inKuandaiList() {
            document.getElementById("kuandaiListModalTitle").innerHTML = "入入入入入入入入入入入入入入入列表";
            $("#kuandaiListFlag").val(1);
            $('#kuandaiListModal').modal('show');

        }

        // 模态框打开
        $('#kuandaiListModal').on('show.bs.modal', function () {
        ...
        // 模态框关闭
        $('#kuandaiListModal').on('hide.bs.modal', function () {
            $("#kuandaiListModalTitle").val("")
            $("#kuandaiListFlag").val(0);
            $("#kuandaiName").val("");
            $("#kuandaiListTableTbody").html("");
            // 当前表
            $("#yonghuSelect").empty();
            // 详情表
            $(".selectpicker" ).selectpicker('refresh');
        ...
        // 模态框的添加按钮
        function addKuandaiList() {
        }

        // 添加宽带缴费记录到待提交列表
        function setKuandaiListDataRow(item) {
            //创建行 
            var row = document.createElement('tr');
                //缴费前余额
            var kuandaiListOldMoneyCell = document.createElement('td');
            kuandaiListOldMoneyCell.innerHTML = item.kuandaiListOldMoney;
            row.appendChild(kuandaiListOldMoneyCell);
                //缴费金额(元)  
            var kuandaiListNewMoneyCell = document.createElement('td');
            kuandaiListNewMoneyCell.innerHTML = item.kuandaiListNewMoney;
            row.appendChild(kuandaiListNewMoneyCell);
                //是否缴费成功  
            ...
            deleteBtn.setAttribute("type", "button");
            deleteBtn.setAttribute("class", "btn btn-danger btn-sm 删除");
            deleteBtn.setAttribute("onclick","removeShowKuandaiOne("+item.id+")");
            deleteBtn.innerHTML = "删除";
            btnGroup.appendChild(deleteBtn);
        ...
        function chickKuandaiNumber(e,id){
            var this_val = e.value || 0;
            if(this_val == 0){
                e.value = "";
                alert("数量为0无意义");
        ...
        function submitKuandaiList() {
            ...
            var flag = parseInt($("#kuandaiListFlag").val());
            var urlParam=null;
            ...
            var msg=null;
            if(flag==1){
                urlParam="inKuandaiList";
                msg="入入入入入入入入入入入入入入入成功";
            }else if(flag==2){
                urlParam="outKuandaiList";
            ...
            httpJson("kuandai/" + urlParam, "POST", {
                map : map,
        ...
        function getId(thisId) {
            ...
            id=thisId;
            $('#showKuandaiListModal').modal('show');
        }

        //模态框打开的时候会执行这个里面的东西
        $('#showKuandaiListModal').on('show.bs.modal', function () {
            //清理表格内容,防止重复回显
            $("#showKuandaiListTableTbody").html("");
            if(id ==null){
                alert("获取当前列id错误,请联系管理员处理");
                $('#showKuandaiListModal').modal('hide');
                return;
            }
            // 当前表
            yonghuSelect();//查询列表
            ...
            showKuandaiList();//查询数据列表
        });
        //模态框关闭的时候会执行这个里面的东西
        $('#showKuandaiListModal').on('hide.bs.modal', function () {
            $("#showKuandaiListTableTbody").html("");
            id=null;
        ...
        // 查询所有数据
        function showKuandaiList() {

            // 当前表的级联表 id定义
            var yonghuId = "";
            // 查询当前数据详情
            http("kuandai/info/"+id, "GET", {}, (res) => {
                if(res.code == 0){
                // 当前表的级联表id赋值
            ...
            http("kuandaiList/page", "GET", {
                ...
                if(res.code == 0){
                    ...
                    for (var i = 0; i < list.length; i++) { //遍历一下表格数据  
                        var trow = setShowKuandaiListDataRow(list[i]); //在 setShowKuandaiListDataRow 中拼接数据,然后返回再追加到列表中
                        $('#showKuandaiListTableTbody').append(trow);
                    }
                }else{
        ...
        // 列表回显
        function setShowKuandaiListDataRow(item) {
            //创建行 
            var row = document.createElement('tr');
                //缴费前余额
            var kuandaiListOldMoneyCell = document.createElement('td');
        ...
        // 删除
        function removeShowKuandaiOne(id) {
            var mymessage = confirm("真的要删除吗？");
            if (mymessage == true) {
                httpJson("kuandaiList/delete?id="+id, "GET",null, (res) => {
                    if(res.code == 0){
                    alert('删除成功');
                    showKuandaiList();
                }else{
        ...
        //新增
        function addShowKuandaiList() {
            httpJson("kuandaiList/save", "POST", paramArray, (res) => {
                if(res.code == 0){
                    alert('新增成功');
                    showKuandaiList();
                }else{
