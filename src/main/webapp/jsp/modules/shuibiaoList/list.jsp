...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">水表缴费记录管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">水表缴费记录列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">水表缴费记录列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="shuibiaoListNewMoneyStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="shuibiaoListNewMoneyChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="shuibiaoListNewMoneyEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="shuibiaoListNewMoneyChickValue(this)"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //缴费金额(元)
            var shuibiaoListNewMoneyStartSearchInput = $('#shuibiaoListNewMoneyStartSearch');
            if(shuibiaoListNewMoneyStartSearchInput != null){
                var shuibiaoListNewMoneyStartSearchValue = shuibiaoListNewMoneyStartSearchInput.val();
                if( shuibiaoListNewMoneyStartSearchValue  != 0){
                    searchForm.shuibiaoListNewMoneyStart = shuibiaoListNewMoneyStartSearchValue;
                }
            }
            var shuibiaoListNewMoneyEndSearchInput = $('#shuibiaoListNewMoneyEndSearch');
            if(shuibiaoListNewMoneyEndSearchInput != null){
                var shuibiaoListNewMoneyEndSearchValue = shuibiaoListNewMoneyEndSearchInput.val();
                if( shuibiaoListNewMoneyEndSearchValue  != 0){
                    searchForm.shuibiaoListNewMoneyEnd = shuibiaoListNewMoneyEndSearchValue;
                }
            }
        ...
        function getDataList() {
            http("shuibiaoList/page", "GET", {
                ...
                order: sortOrder,
                //本表的
                shuibiaoListNewMoneyStart: searchForm.shuibiaoListNewMoneyStart,
                shuibiaoListNewMoneyEnd: searchForm.shuibiaoListNewMoneyEnd,
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("shuibiaoList/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addshuibiaoList", "addshuibiaoList");
            window.location.href = "add-or-update.jsp"
        }
