            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">水表缴费记录登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="shuibiaoAddress" name="shuibiaoAddress" class="form-control"
                                                   v-model="ruleForm.shuibiaoAddress" readonly>
                                        </div>
                                ...
                                <input id="shuibiaoId" name="shuibiaoId" v-model="ruleForm.shuibiaoId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="shuibiaoListOldMoney" name="shuibiaoListOldMoney" class="form-control"
                                               v-model="ruleForm.shuibiaoListOldMoney" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="shuibiaoListNewMoney" name="shuibiaoListNewMoney" class="form-control"
                                               v-model="ruleForm.shuibiaoListNewMoney" readonly>
                                    </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "shuibiaoList/info/" + id,
