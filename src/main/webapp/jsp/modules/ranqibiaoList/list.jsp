...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">燃气表缴费记录管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">燃气表缴费记录列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">燃气表缴费记录列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="ranqibiaoListNewMoneyStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="ranqibiaoListNewMoneyChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="ranqibiaoListNewMoneyEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="ranqibiaoListNewMoneyChickValue(this)"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //缴费金额(元)
            var ranqibiaoListNewMoneyStartSearchInput = $('#ranqibiaoListNewMoneyStartSearch');
            if(ranqibiaoListNewMoneyStartSearchInput != null){
                var ranqibiaoListNewMoneyStartSearchValue = ranqibiaoListNewMoneyStartSearchInput.val();
                if( ranqibiaoListNewMoneyStartSearchValue  != 0){
                    searchForm.ranqibiaoListNewMoneyStart = ranqibiaoListNewMoneyStartSearchValue;
                }
            }
            var ranqibiaoListNewMoneyEndSearchInput = $('#ranqibiaoListNewMoneyEndSearch');
            if(ranqibiaoListNewMoneyEndSearchInput != null){
                var ranqibiaoListNewMoneyEndSearchValue = ranqibiaoListNewMoneyEndSearchInput.val();
                if( ranqibiaoListNewMoneyEndSearchValue  != 0){
                    searchForm.ranqibiaoListNewMoneyEnd = ranqibiaoListNewMoneyEndSearchValue;
                }
            }
        ...
        function getDataList() {
            http("ranqibiaoList/page", "GET", {
                ...
                order: sortOrder,
                //本表的
                ranqibiaoListNewMoneyStart: searchForm.ranqibiaoListNewMoneyStart,
                ranqibiaoListNewMoneyEnd: searchForm.ranqibiaoListNewMoneyEnd,
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("ranqibiaoList/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addranqibiaoList", "addranqibiaoList");
            window.location.href = "add-or-update.jsp"
        }
