...
<body>
    ...
    <div class="modal fade" id="gongnuanListModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <%-- 模态框标题--%>
                <div class="modal-header">
                    <h5 class="modal-title" id="gongnuanListModalTitle">列表</h5>
                ...
                <div class="modal-body">
                    <div class="col-sm-12">
                        ...
                        <%-- 详情表 --%>
                        <input type="hidden" id="gongnuanListFlag">
                        <label class="col-sm-1">
                            <button onclick="addGongnuanList()" type="button" class="btn btn-success 新增">添加</button>
                        </label>
                    </div>
                    <%-- 列表 --%>
                    <table id="gongnuanTable" class="table table-bordered table-striped">
                        <thead>
                        <tr>
                            <th >缴费前余额</th>
                            <th >缴费金额(元)</th>
                        ...
                        <tbody id="gongnuanListTableTbody">
                        </tbody>
                    </table>
                </div>
                <%-- 模态框按钮 --%>
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="submitGongnuanList()" class="btn btn-primary">提交</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <%--  列表查看 --%>
    <div class="modal fade" id="showGongnuanListModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <%-- 模态框标题--%>
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <%--<div class="col-sm-12">
                        &lt;%&ndash; 当前表 &ndash;%&gt;
                        <label class="col-sm-1">
                            <button onclick="addShowGongnuanList()" type="button" class="btn btn-success 新增">添加</button>
                        </label>
                    </div>--%>
                    <table id="inOutTableList" class="table table-bordered table-striped">
                        ...
                        <tbody id="showGongnuanListTableTbody">
                        </tbody>
                    </table>
                </div>
                <%-- 模态框按钮 --%>
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">供暖管理</li>
                            <li class="breadcrumb-item active">供暖列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        供暖编号
                                        <div class="layui-input-inline">
                                            <input type="text" id="gongnuanNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="供暖编号" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        供暖余额
                                        <div class="layui-input-inline">
                                            <input type="text" id="gongnuanMoneyStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="gongnuanMoneyChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="gongnuanMoneyEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="gongnuanMoneyChickValue(this)"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        供暖编号所在地址
                                        <div class="layui-input-inline">
                                            <input type="text" id="gongnuanAddressSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="供暖编号所在地址" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                                        ...
                                        <%--<button onclick="outGongnuanList()" type="button" class="btn btn-success 新增">出出出出出出出出出出出出出出出</button>--%>
...
// 当前表关联
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //供暖编号
            var gongnuanNumberSearchInput = $('#gongnuanNumberSearch');
            if( gongnuanNumberSearchInput != null){
                if (gongnuanNumberSearchInput.val() != null && gongnuanNumberSearchInput.val() != '') {
                    searchForm.gongnuanNumber = $('#gongnuanNumberSearch').val();
                }
            }
     
            //供暖余额
            var gongnuanMoneyStartSearchInput = $('#gongnuanMoneyStartSearch');
            if(gongnuanMoneyStartSearchInput != null){
                var gongnuanMoneyStartSearchValue = gongnuanMoneyStartSearchInput.val();
                if( gongnuanMoneyStartSearchValue  != 0){
                    searchForm.gongnuanMoneyStart = gongnuanMoneyStartSearchValue;
                }
            }
            var gongnuanMoneyEndSearchInput = $('#gongnuanMoneyEndSearch');
            if(gongnuanMoneyEndSearchInput != null){
                var gongnuanMoneyEndSearchValue = gongnuanMoneyEndSearchInput.val();
                if( gongnuanMoneyEndSearchValue  != 0){
                    searchForm.gongnuanMoneyEnd = gongnuanMoneyEndSearchValue;
                }
            }
     
            //供暖编号所在地址
            var gongnuanAddressSearchInput = $('#gongnuanAddressSearch');
            if( gongnuanAddressSearchInput != null){
                if (gongnuanAddressSearchInput.val() != null && gongnuanAddressSearchInput.val() != '') {
                    searchForm.gongnuanAddress = $('#gongnuanAddressSearch').val();
                }
            }
                getDataList();
        }
        ...
        function getDataList() {
            http("gongnuan/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                //本表的
                gongnuanNumber: searchForm.gongnuanNumber,
                gongnuanMoneyStart: searchForm.gongnuanMoneyStart,
                gongnuanMoneyEnd: searchForm.gongnuanMoneyEnd,
                gongnuanAddress: searchForm.gongnuanAddress,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //供暖编号
            var gongnuanNumberCell = document.createElement('td');
            gongnuanNumberCell.innerHTML = item.gongnuanNumber;
            row.appendChild(gongnuanNumberCell);


            //供暖余额
            var gongnuanMoneyCell = document.createElement('td');
            gongnuanMoneyCell.innerHTML = item.gongnuanMoney;
            row.appendChild(gongnuanMoneyCell);


            //供暖编号所在地址
            var gongnuanAddressCell = document.createElement('td');
            gongnuanAddressCell.innerHTML = item.gongnuanAddress;
            row.appendChild(gongnuanAddressCell);
            ...
            // 小数
            function gongnuanMoneyChickValue(e){
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("gongnuan/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addgongnuan", "addgongnuan");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //查询当前表搜索条件所有列表
        ...
        //出出出出出出出出出出出出出出出
        function outGongnuanList() {
            document.getElementById("gongnuanListModalTitle").innerHTML = "出出出出出出出出出出出出出出出列表";
            $("#gongnuanListFlag").val(2);
            $('#gongnuanListModal').modal('show');
        }
        //入入入入入入入入入入入入入入入
        function inGongnuanList() {
            document.getElementById("gongnuanListModalTitle").innerHTML = "入入入入入入入入入入入入入入入列表";
            $("#gongnuanListFlag").val(1);
            $('#gongnuanListModal').modal('show');

        }

        // 模态框打开
        $('#gongnuanListModal').on('show.bs.modal', function () {
        ...
        // 模态框关闭
        $('#gongnuanListModal').on('hide.bs.modal', function () {
            $("#gongnuanListModalTitle").val("")
            $("#gongnuanListFlag").val(0);
            $("#gongnuanName").val("");
            $("#gongnuanListTableTbody").html("");
            // 当前表
            $("#yonghuSelect").empty();
            // 详情表
            $(".selectpicker" ).selectpicker('refresh');
        ...
        // 模态框的添加按钮
        function addGongnuanList() {
        }

        // 添加供暖缴费记录到待提交列表
        function setGongnuanListDataRow(item) {
            //创建行 
            var row = document.createElement('tr');
                //缴费前余额
            var gongnuanListOldMoneyCell = document.createElement('td');
            gongnuanListOldMoneyCell.innerHTML = item.gongnuanListOldMoney;
            row.appendChild(gongnuanListOldMoneyCell);
                //缴费金额(元)  
            var gongnuanListNewMoneyCell = document.createElement('td');
            gongnuanListNewMoneyCell.innerHTML = item.gongnuanListNewMoney;
            row.appendChild(gongnuanListNewMoneyCell);
                //是否缴费成功  
            ...
            deleteBtn.setAttribute("type", "button");
            deleteBtn.setAttribute("class", "btn btn-danger btn-sm 删除");
            deleteBtn.setAttribute("onclick","removeShowGongnuanOne("+item.id+")");
            deleteBtn.innerHTML = "删除";
            btnGroup.appendChild(deleteBtn);
        ...
        function chickGongnuanNumber(e,id){
            var this_val = e.value || 0;
            if(this_val == 0){
                e.value = "";
                alert("数量为0无意义");
        ...
        function submitGongnuanList() {
            ...
            var flag = parseInt($("#gongnuanListFlag").val());
            var urlParam=null;
            ...
            var msg=null;
            if(flag==1){
                urlParam="inGongnuanList";
                msg="入入入入入入入入入入入入入入入成功";
            }else if(flag==2){
                urlParam="outGongnuanList";
            ...
            httpJson("gongnuan/" + urlParam, "POST", {
                map : map,
                gongnuanName : gongnuanName,
                // 当前表表关联
                yonghuId : $('#yonghuSelect option:selected').val(),//把下拉框选中的值传过去,没有就传个空
        }, (res) => {
                if(res.code == 0){
                    alert(msg);
                    $('#gongnuanListModal').modal('hide');
                    getDataList();
                }else{
                    alert(res.msg);
                }
        ...
        function getId(thisId) {
            ...
            id=thisId;
            $('#showGongnuanListModal').modal('show');
        }

        //模态框打开的时候会执行这个里面的东西
        $('#showGongnuanListModal').on('show.bs.modal', function () {
            //清理表格内容,防止重复回显
            $("#showGongnuanListTableTbody").html("");
            if(id ==null){
                alert("获取当前列id错误,请联系管理员处理");
                $('#showGongnuanListModal').modal('hide');
                return;
            }
            // 当前表
            yonghuSelect();//查询列表
            ...
            showGongnuanList();//查询数据列表
        });
        //模态框关闭的时候会执行这个里面的东西
        $('#showGongnuanListModal').on('hide.bs.modal', function () {
            $("#showGongnuanListTableTbody").html("");
            id=null;
        ...
        // 查询所有数据
        function showGongnuanList() {

            // 当前表的级联表 id定义
            var yonghuId = "";
            // 查询当前数据详情
            http("gongnuan/info/"+id, "GET", {}, (res) => {
                if(res.code == 0){
                // 当前表的级联表id赋值
            ...
            http("gongnuanList/page", "GET", {
                ...
                if(res.code == 0){
                    ...
                    for (var i = 0; i < list.length; i++) { //遍历一下表格数据  
                        var trow = setShowGongnuanListDataRow(list[i]); //在 setShowGongnuanListDataRow 中拼接数据,然后返回再追加到列表中
                        $('#showGongnuanListTableTbody').append(trow);
                    }
                }else{
        ...
        // 列表回显
        function setShowGongnuanListDataRow(item) {
            //创建行 
            var row = document.createElement('tr');
                //缴费前余额
            var gongnuanListOldMoneyCell = document.createElement('td');
        ...
        // 删除
        function removeShowGongnuanOne(id) {
            var mymessage = confirm("真的要删除吗？");
            if (mymessage == true) {
                httpJson("gongnuanList/delete?id="+id, "GET",null, (res) => {
                    if(res.code == 0){
                    alert('删除成功');
                    showGongnuanList();
                }else{
        ...
        //新增
        function addShowGongnuanList() {
            httpJson("gongnuanList/save", "POST", paramArray, (res) => {
                if(res.code == 0){
                    alert('新增成功');
                    showGongnuanList();
                }else{
        ...
        function jiaofeiSubmit() {
            ...
            httpJson("gongnuan/jiaofei", "POST", {
