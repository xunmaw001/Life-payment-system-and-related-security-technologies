            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑ETC</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">ETC信息</h3>
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="etcMoney" name="etcMoney" class="form-control"
                                               onchange="etcMoneyChickValue(this)" placeholder="ETC余额" value="0" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>ETC编号所在地址</label>
                                        <input id="etcAddress" name="etcAddress" class="form-control"
                                               placeholder="ETC编号所在地址">
                                    </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("etc/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addetc');
    ...
    // 获取当前详情
    function getDetails() {
        var addetc = window.sessionStorage.getItem("addetc");
        if (addetc != null && addetc != "" && addetc != "null") {
            window.sessionStorage.removeItem('addetc');
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("etc/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
