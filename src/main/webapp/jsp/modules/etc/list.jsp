...
<body>
    ...
    <div class="modal fade" id="etcListModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <%-- 模态框标题--%>
                <div class="modal-header">
                    <h5 class="modal-title" id="etcListModalTitle">列表</h5>
                ...
                <div class="modal-body">
                    <div class="col-sm-12">
                        ...
                        <%-- 详情表 --%>
                        <input type="hidden" id="etcListFlag">
                        <label class="col-sm-1">
                            <button onclick="addEtcList()" type="button" class="btn btn-success 新增">添加</button>
                        </label>
                    </div>
                    <%-- 列表 --%>
                    <table id="etcTable" class="table table-bordered table-striped">
                        <thead>
                        <tr>
                            <th >缴费前余额</th>
                            <th >缴费金额(元)</th>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="submitEtcList()" class="btn btn-primary">提交</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <%--  列表查看 --%>
    <div class="modal fade" id="showEtcListModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <%-- 模态框标题--%>
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <%--<div class="col-sm-12">
                        &lt;%&ndash; 当前表 &ndash;%&gt;
                        <label class="col-sm-1">
                            <button onclick="addShowEtcList()" type="button" class="btn btn-success 新增">添加</button>
                        </label>
                    </div>--%>
                    <table id="inOutTableList" class="table table-bordered table-striped">
                        ...
                        <tbody id="showEtcListTableTbody">
                        </tbody>
                    </table>
                </div>
                <%-- 模态框按钮 --%>
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">ETC管理</li>
                            <li class="breadcrumb-item active">ETC列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">ETC列表</h3>
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ETC编号
                                        <div class="layui-input-inline">
                                            <input type="text" id="etcNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="ETC编号" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ETC余额
                                        <div class="layui-input-inline">
                                            <input type="text" id="etcMoneyStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="etcMoneyChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="etcMoneyEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="etcMoneyChickValue(this)"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ETC编号所在地址
                                        <div class="layui-input-inline">
                                            <input type="text" id="etcAddressSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="ETC编号所在地址" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                                        ...
                                        <%--<button onclick="outEtcList()" type="button" class="btn btn-success 新增">出出出出出出出出出出出出出出出</button>--%>
...
// 当前表关联
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //ETC编号
            var etcNumberSearchInput = $('#etcNumberSearch');
            if( etcNumberSearchInput != null){
                if (etcNumberSearchInput.val() != null && etcNumberSearchInput.val() != '') {
                    searchForm.etcNumber = $('#etcNumberSearch').val();
                }
            }
     
            //ETC余额
            var etcMoneyStartSearchInput = $('#etcMoneyStartSearch');
            if(etcMoneyStartSearchInput != null){
                var etcMoneyStartSearchValue = etcMoneyStartSearchInput.val();
                if( etcMoneyStartSearchValue  != 0){
                    searchForm.etcMoneyStart = etcMoneyStartSearchValue;
                }
            }
            var etcMoneyEndSearchInput = $('#etcMoneyEndSearch');
            if(etcMoneyEndSearchInput != null){
                var etcMoneyEndSearchValue = etcMoneyEndSearchInput.val();
                if( etcMoneyEndSearchValue  != 0){
                    searchForm.etcMoneyEnd = etcMoneyEndSearchValue;
                }
            }
     
            //ETC编号所在地址
            var etcAddressSearchInput = $('#etcAddressSearch');
            if( etcAddressSearchInput != null){
                if (etcAddressSearchInput.val() != null && etcAddressSearchInput.val() != '') {
                    searchForm.etcAddress = $('#etcAddressSearch').val();
                }
            }
                getDataList();
        }
        ...
        function getDataList() {
            http("etc/page", "GET", {
                ...
                order: sortOrder,
                //本表的
                etcNumber: searchForm.etcNumber,
                etcMoneyStart: searchForm.etcMoneyStart,
                etcMoneyEnd: searchForm.etcMoneyEnd,
                etcAddress: searchForm.etcAddress,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //ETC编号
            var etcNumberCell = document.createElement('td');
            etcNumberCell.innerHTML = item.etcNumber;
            row.appendChild(etcNumberCell);


            //ETC余额
            var etcMoneyCell = document.createElement('td');
            etcMoneyCell.innerHTML = item.etcMoney;
            row.appendChild(etcMoneyCell);


            //ETC编号所在地址
            var etcAddressCell = document.createElement('td');
            etcAddressCell.innerHTML = item.etcAddress;
            row.appendChild(etcAddressCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("etc/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addetc", "addetc");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //查询当前表搜索条件所有列表
        ...
        //出出出出出出出出出出出出出出出
        function outEtcList() {
            document.getElementById("etcListModalTitle").innerHTML = "出出出出出出出出出出出出出出出列表";
            $("#etcListFlag").val(2);
            $('#etcListModal').modal('show');
        }
        //入入入入入入入入入入入入入入入
        function inEtcList() {
            document.getElementById("etcListModalTitle").innerHTML = "入入入入入入入入入入入入入入入列表";
            $("#etcListFlag").val(1);
            $('#etcListModal').modal('show');
        ...
        // 模态框打开
        $('#etcListModal').on('show.bs.modal', function () {
        ...
        // 模态框关闭
        $('#etcListModal').on('hide.bs.modal', function () {
            $("#etcListModalTitle").val("")
            $("#etcListFlag").val(0);
            $("#etcName").val("");
            $("#etcListTableTbody").html("");
            // 当前表
            $("#yonghuSelect").empty();
            // 详情表
            $(".selectpicker" ).selectpicker('refresh');
        ...
        // 添加ETC缴费记录到待提交列表
        function setEtcListDataRow(item) {
            //创建行 
            var row = document.createElement('tr');
                //缴费前余额
            var etcListOldMoneyCell = document.createElement('td');
            etcListOldMoneyCell.innerHTML = item.etcListOldMoney;
            row.appendChild(etcListOldMoneyCell);
                //缴费金额(元)  
            var etcListNewMoneyCell = document.createElement('td');
            etcListNewMoneyCell.innerHTML = item.etcListNewMoney;
            row.appendChild(etcListNewMoneyCell);
                //是否缴费成功  
            ...
            deleteBtn.setAttribute("type", "button");
            deleteBtn.setAttribute("class", "btn btn-danger btn-sm 删除");
            deleteBtn.setAttribute("onclick","removeShowEtcOne("+item.id+")");
            deleteBtn.innerHTML = "删除";
            btnGroup.appendChild(deleteBtn);
        ...
        function submitEtcList() {
            ...
            var flag = parseInt($("#etcListFlag").val());
            var urlParam=null;
        ...
        function getId(thisId) {
            ...
            id=thisId;
            $('#showEtcListModal').modal('show');
        }

        //模态框打开的时候会执行这个里面的东西
        $('#showEtcListModal').on('show.bs.modal', function () {
            //清理表格内容,防止重复回显
            $("#showEtcListTableTbody").html("");
            if(id ==null){
                alert("获取当前列id错误,请联系管理员处理");
                $('#showEtcListModal').modal('hide');
                return;
            }
            // 当前表
            yonghuSelect();//查询列表
        ...
        //模态框关闭的时候会执行这个里面的东西
        $('#showEtcListModal').on('hide.bs.modal', function () {
            $("#showEtcListTableTbody").html("");
            id=null;
            ...
            http("etcList/page", "GET", {
                ...
                if(res.code == 0){
                    ...
                    for (var i = 0; i < list.length; i++) { //遍历一下表格数据  
                        var trow = setShowEtcListDataRow(list[i]); //在 setShowEtcListDataRow 中拼接数据,然后返回再追加到列表中
                        $('#showEtcListTableTbody').append(trow);
                    }
                }else{
        ...
        // 列表回显
        function setShowEtcListDataRow(item) {
            //创建行 
            var row = document.createElement('tr');
                //缴费前余额
            var etcListOldMoneyCell = document.createElement('td');
        ...
        // 删除
        function removeShowEtcOne(id) {
            var mymessage = confirm("真的要删除吗？");
            if (mymessage == true) {
                httpJson("etcList/delete?id="+id, "GET",null, (res) => {
                    if(res.code == 0){
                    alert('删除成功');
                    showEtcList();
                }else{
        ...
        //新增
        function addShowEtcList() {
            httpJson("etcList/save", "POST", paramArray, (res) => {
                if(res.code == 0){
                    alert('新增成功');
                    showEtcList();
                }else{
