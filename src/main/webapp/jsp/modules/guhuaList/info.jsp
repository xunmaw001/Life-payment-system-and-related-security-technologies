            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">固话缴费记录登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="guhuaNumber" name="guhuaNumber" class="form-control"
                                                   v-model="ruleForm.guhuaNumber" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="guhuaMoney" name="guhuaMoney" class="form-control"
                                                   v-model="ruleForm.guhuaMoney" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="guhuaAddress" name="guhuaAddress" class="form-control"
                                                   v-model="ruleForm.guhuaAddress" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="guhuaId" name="guhuaId" v-model="ruleForm.guhuaId" readonly type="hidden">

                                    <div class="form-group col-md-6">
                                        <label>缴费前余额</label>
                                        <input id="guhuaListOldMoney" name="guhuaListOldMoney" class="form-control"
                                               v-model="ruleForm.guhuaListOldMoney" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="guhuaListNewMoney" name="guhuaListNewMoney" class="form-control"
                                               v-model="ruleForm.guhuaListNewMoney" readonly>
                                    </div>
