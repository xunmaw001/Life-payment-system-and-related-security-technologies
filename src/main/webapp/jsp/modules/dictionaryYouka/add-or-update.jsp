    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑油卡所属公司</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">油卡所属公司管理</li>
                        <li class="breadcrumb-item active">编辑油卡所属公司</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">油卡所属公司表信息</h3>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "youka_types";
            data["dicName"] = "油卡所属公司名称";
