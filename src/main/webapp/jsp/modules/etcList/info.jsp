            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">ETC缴费记录登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="etcNumber" name="etcNumber" class="form-control"
                                                   v-model="ruleForm.etcNumber" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="etcMoney" name="etcMoney" class="form-control"
                                                   v-model="ruleForm.etcMoney" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="etcAddress" name="etcAddress" class="form-control"
                                                   v-model="ruleForm.etcAddress" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="etcId" name="etcId" v-model="ruleForm.etcId" readonly type="hidden">

                                    <div class="form-group col-md-6">
                                        <label>缴费前余额</label>
                                        <input id="etcListOldMoney" name="etcListOldMoney" class="form-control"
                                               v-model="ruleForm.etcListOldMoney" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="etcListNewMoney" name="etcListNewMoney" class="form-control"
                                               v-model="ruleForm.etcListNewMoney" readonly>
                                    </div>
