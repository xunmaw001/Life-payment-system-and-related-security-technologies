...
<body>
    ...
    <div class="modal fade" id="guhuaListModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <%-- 模态框标题--%>
                <div class="modal-header">
                    <h5 class="modal-title" id="guhuaListModalTitle">列表</h5>
                ...
                <div class="modal-body">
                    <div class="col-sm-12">
                        ...
                        <%-- 详情表 --%>
                        <input type="hidden" id="guhuaListFlag">
                        <label class="col-sm-1">
                            <button onclick="addGuhuaList()" type="button" class="btn btn-success 新增">添加</button>
                        </label>
                    </div>
                    <%-- 列表 --%>
                    <table id="guhuaTable" class="table table-bordered table-striped">
                        <thead>
                        <tr>
                            <th >缴费前余额</th>
                            <th >缴费金额(元)</th>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="submitGuhuaList()" class="btn btn-primary">提交</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <%--  列表查看 --%>
    <div class="modal fade" id="showGuhuaListModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <%-- 模态框标题--%>
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <%--<div class="col-sm-12">
                        &lt;%&ndash; 当前表 &ndash;%&gt;
                        <label class="col-sm-1">
                            <button onclick="addShowGuhuaList()" type="button" class="btn btn-success 新增">添加</button>
                        </label>
                    </div>--%>
                    <table id="inOutTableList" class="table table-bordered table-striped">
                        ...
                        <tbody id="showGuhuaListTableTbody">
                        </tbody>
                    </table>
                </div>
                <%-- 模态框按钮 --%>
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">固话管理</li>
                            <li class="breadcrumb-item active">固话列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        固话编号
                                        <div class="layui-input-inline">
                                            <input type="text" id="guhuaNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="固话编号" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        固话余额
                                        <div class="layui-input-inline">
                                            <input type="text" id="guhuaMoneyStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="guhuaMoneyChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="guhuaMoneyEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="guhuaMoneyChickValue(this)"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        固话编号所在地址
                                        <div class="layui-input-inline">
                                            <input type="text" id="guhuaAddressSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="固话编号所在地址" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                                        ...
                                        <%--<button onclick="outGuhuaList()" type="button" class="btn btn-success 新增">出出出出出出出出出出出出出出出</button>--%>
...
// 当前表关联
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //固话编号
            var guhuaNumberSearchInput = $('#guhuaNumberSearch');
            if( guhuaNumberSearchInput != null){
                if (guhuaNumberSearchInput.val() != null && guhuaNumberSearchInput.val() != '') {
                    searchForm.guhuaNumber = $('#guhuaNumberSearch').val();
                }
            }
     
            //固话余额
            var guhuaMoneyStartSearchInput = $('#guhuaMoneyStartSearch');
            if(guhuaMoneyStartSearchInput != null){
                var guhuaMoneyStartSearchValue = guhuaMoneyStartSearchInput.val();
                if( guhuaMoneyStartSearchValue  != 0){
                    searchForm.guhuaMoneyStart = guhuaMoneyStartSearchValue;
                }
            }
            var guhuaMoneyEndSearchInput = $('#guhuaMoneyEndSearch');
            if(guhuaMoneyEndSearchInput != null){
                var guhuaMoneyEndSearchValue = guhuaMoneyEndSearchInput.val();
                if( guhuaMoneyEndSearchValue  != 0){
                    searchForm.guhuaMoneyEnd = guhuaMoneyEndSearchValue;
                }
            }
     
            //固话编号所在地址
            var guhuaAddressSearchInput = $('#guhuaAddressSearch');
            if( guhuaAddressSearchInput != null){
                if (guhuaAddressSearchInput.val() != null && guhuaAddressSearchInput.val() != '') {
                    searchForm.guhuaAddress = $('#guhuaAddressSearch').val();
                }
            }
                getDataList();
        }
        ...
        function getDataList() {
            http("guhua/page", "GET", {
                ...
                order: sortOrder,
                //本表的
                guhuaNumber: searchForm.guhuaNumber,
                guhuaMoneyStart: searchForm.guhuaMoneyStart,
                guhuaMoneyEnd: searchForm.guhuaMoneyEnd,
                guhuaAddress: searchForm.guhuaAddress,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //固话编号
            var guhuaNumberCell = document.createElement('td');
            guhuaNumberCell.innerHTML = item.guhuaNumber;
            row.appendChild(guhuaNumberCell);


            //固话余额
            var guhuaMoneyCell = document.createElement('td');
            guhuaMoneyCell.innerHTML = item.guhuaMoney;
            row.appendChild(guhuaMoneyCell);


            //固话编号所在地址
            var guhuaAddressCell = document.createElement('td');
            guhuaAddressCell.innerHTML = item.guhuaAddress;
            row.appendChild(guhuaAddressCell);
            ...
            // 小数
            function guhuaMoneyChickValue(e){
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("guhua/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addguhua", "addguhua");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //查询当前表搜索条件所有列表
        ...
        //出出出出出出出出出出出出出出出
        function outGuhuaList() {
            document.getElementById("guhuaListModalTitle").innerHTML = "出出出出出出出出出出出出出出出列表";
            $("#guhuaListFlag").val(2);
            $('#guhuaListModal').modal('show');
        }
        //入入入入入入入入入入入入入入入
        function inGuhuaList() {
            document.getElementById("guhuaListModalTitle").innerHTML = "入入入入入入入入入入入入入入入列表";
            $("#guhuaListFlag").val(1);
            $('#guhuaListModal').modal('show');
        ...
        // 模态框打开
        $('#guhuaListModal').on('show.bs.modal', function () {
        ...
        // 模态框关闭
        $('#guhuaListModal').on('hide.bs.modal', function () {
            $("#guhuaListModalTitle").val("")
            $("#guhuaListFlag").val(0);
            $("#guhuaName").val("");
            $("#guhuaListTableTbody").html("");
            // 当前表
            $("#yonghuSelect").empty();
            // 详情表
            $(".selectpicker" ).selectpicker('refresh');
        ...
        // 模态框的添加按钮
        function addGuhuaList() {
        }

        // 添加固话缴费记录到待提交列表
        function setGuhuaListDataRow(item) {
            //创建行 
            var row = document.createElement('tr');
                //缴费前余额
            var guhuaListOldMoneyCell = document.createElement('td');
            guhuaListOldMoneyCell.innerHTML = item.guhuaListOldMoney;
            row.appendChild(guhuaListOldMoneyCell);
                //缴费金额(元)  
            var guhuaListNewMoneyCell = document.createElement('td');
            guhuaListNewMoneyCell.innerHTML = item.guhuaListNewMoney;
            row.appendChild(guhuaListNewMoneyCell);
                //是否缴费成功  
            ...
            deleteBtn.setAttribute("type", "button");
            deleteBtn.setAttribute("class", "btn btn-danger btn-sm 删除");
            deleteBtn.setAttribute("onclick","removeShowGuhuaOne("+item.id+")");
            deleteBtn.innerHTML = "删除";
            btnGroup.appendChild(deleteBtn);
        ...
        function chickGuhuaNumber(e,id){
            var this_val = e.value || 0;
            if(this_val == 0){
                e.value = "";
                alert("数量为0无意义");
        ...
        function submitGuhuaList() {
            ...
            var flag = parseInt($("#guhuaListFlag").val());
            var urlParam=null;
            ...
            var msg=null;
            if(flag==1){
                urlParam="inGuhuaList";
                msg="入入入入入入入入入入入入入入入成功";
            }else if(flag==2){
                urlParam="outGuhuaList";
        ...
        function getId(thisId) {
            ...
            id=thisId;
            $('#showGuhuaListModal').modal('show');
        }

        //模态框打开的时候会执行这个里面的东西
        $('#showGuhuaListModal').on('show.bs.modal', function () {
            //清理表格内容,防止重复回显
            $("#showGuhuaListTableTbody").html("");
            if(id ==null){
                alert("获取当前列id错误,请联系管理员处理");
                $('#showGuhuaListModal').modal('hide');
                return;
            }
            // 当前表
            yonghuSelect();//查询列表
            ...
            showGuhuaList();//查询数据列表
        });
        //模态框关闭的时候会执行这个里面的东西
        $('#showGuhuaListModal').on('hide.bs.modal', function () {
            $("#showGuhuaListTableTbody").html("");
            id=null;
            ...
            http("guhuaList/page", "GET", {
                ...
                if(res.code == 0){
                    ...
                    for (var i = 0; i < list.length; i++) { //遍历一下表格数据  
                        var trow = setShowGuhuaListDataRow(list[i]); //在 setShowGuhuaListDataRow 中拼接数据,然后返回再追加到列表中
                        $('#showGuhuaListTableTbody').append(trow);
                    }
                }else{
        ...
        // 列表回显
        function setShowGuhuaListDataRow(item) {
            //创建行 
            var row = document.createElement('tr');
                //缴费前余额
            var guhuaListOldMoneyCell = document.createElement('td');
        ...
        // 删除
        function removeShowGuhuaOne(id) {
            var mymessage = confirm("真的要删除吗？");
            if (mymessage == true) {
                httpJson("guhuaList/delete?id="+id, "GET",null, (res) => {
                    if(res.code == 0){
                    alert('删除成功');
                    showGuhuaList();
                }else{
        ...
        //新增
        function addShowGuhuaList() {
            httpJson("guhuaList/save", "POST", paramArray, (res) => {
                if(res.code == 0){
                    alert('新增成功');
                    showGuhuaList();
                }else{
