            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">ETC缴费记录展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="etcListNewMoneyStart" id="etcListNewMoneyStart"  lay-skin="double"   placeholder="缴费金额(元)开始" autocomplete="off" class="layui-input">
                              -
                              <input type="text" name="etcListNewMoneyend"   id="etcListNewMoneyend"    lay-skin="double|etcListNewMoneyend"   placeholder="缴费金额(元)结束" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 etcListContent 字段去除无用字符 如果字段长度大于60  就截取到60
            etcListContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        form.verify({
            ...
            ,etcListNewMoneyend: function(value, item){ //value：表单的值、item：表单的DOM对象
                var etcListNewMoneyStart = $("#etcListNewMoneyStart").val();
                if(etcListNewMoneyStart != null && etcListNewMoneyStart != "" && etcListNewMoneyStart != "null"){
                    var number = parseInt(value)- parseInt(etcListNewMoneyStart);
                    if(number<0){
        ...
        function pageList() {
            ...
            if (jquery('#etcListNewMoneyStart').val() != null && jquery('#etcListNewMoneyStart').val() != "" && jquery('#etcListNewMoneyStart').val() != "null" ) {
                param['etcListNewMoneyStart'] = jquery('#etcListNewMoneyStart').val();
            }
            if (jquery('#etcListNewMoneyEnd').val() != null && jquery('#etcListNewMoneyEnd').val() != "" && jquery('#etcListNewMoneyEnd').val() != "null" ) {
                param['etcListNewMoneyEnd'] = jquery('#etcListNewMoneyEnd').val();
            }
            ...
            if (successTypes != null && successTypes != "" && successTypes != "null") {
                ...
                // 获取列表数据
            http.request('etcList/list', 'get', param, function(res) {
