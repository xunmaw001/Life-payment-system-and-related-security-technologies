              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">宽带编号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="kuandaiNumber" id="kuandaiNumber"  placeholder="宽带编号"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">宽带余额:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="kuandaiMoney" id="kuandaiMoney"  lay-verify="double|required"   placeholder="宽带余额" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">宽带编号所在地址:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="kuandaiAddress" id="kuandaiAddress"  placeholder="宽带编号所在地址"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
