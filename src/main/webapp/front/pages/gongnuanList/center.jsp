	...
	<body style="background: #EEEEEE;">
		...
		<div id="app">
			...
			<div class="layui-form-item">
                <div class="layui-block">
                    ...
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="gongnuanListOldMoney" id="gongnuanListOldMoney"  lay-verify="required|double"   placeholder="缴费前余额" autocomplete="off" class="layui-input" style="width: 500px">
			...
			<div class="layui-form-item">
                <div class="layui-block">
                    ...
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="gongnuanListNewMoney" id="gongnuanListNewMoney"  lay-verify="required|double"   placeholder="缴费金额(元)" autocomplete="off" class="layui-input" style="width: 500px">
                        <div class="layui-form-mid layui-word-aux">
                            <i class="layui-icon" style="font-size: 20px;color: red;">&#xe65e;</i>
                            <a id="btn-recharge" href="javascript:void(0)">点我充值</a>
                        </div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function () {
                ...
                http.request(`gongnuanList/session`, 'get', {}, function (data) {
                    // 表单赋值
