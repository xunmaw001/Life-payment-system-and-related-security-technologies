            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">供暖缴费记录展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="gongnuanListNewMoneyStart" id="gongnuanListNewMoneyStart"  lay-skin="double"   placeholder="缴费金额(元)开始" autocomplete="off" class="layui-input">
                              -
                              <input type="text" name="gongnuanListNewMoneyend"   id="gongnuanListNewMoneyend"    lay-skin="double|gongnuanListNewMoneyend"   placeholder="缴费金额(元)结束" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 gongnuanListContent 字段去除无用字符 如果字段长度大于60  就截取到60
            gongnuanListContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        form.verify({
            ...
            ,gongnuanListNewMoneyend: function(value, item){ //value：表单的值、item：表单的DOM对象
                var gongnuanListNewMoneyStart = $("#gongnuanListNewMoneyStart").val();
                if(gongnuanListNewMoneyStart != null && gongnuanListNewMoneyStart != "" && gongnuanListNewMoneyStart != "null"){
                    var number = parseInt(value)- parseInt(gongnuanListNewMoneyStart);
                    if(number<0){
        ...
        function pageList() {
            ...
            if (jquery('#gongnuanListNewMoneyStart').val() != null && jquery('#gongnuanListNewMoneyStart').val() != "" && jquery('#gongnuanListNewMoneyStart').val() != "null" ) {
                param['gongnuanListNewMoneyStart'] = jquery('#gongnuanListNewMoneyStart').val();
            }
            if (jquery('#gongnuanListNewMoneyEnd').val() != null && jquery('#gongnuanListNewMoneyEnd').val() != "" && jquery('#gongnuanListNewMoneyEnd').val() != "null" ) {
                param['gongnuanListNewMoneyEnd'] = jquery('#gongnuanListNewMoneyEnd').val();
            }
            ...
            if (successTypes != null && successTypes != "" && successTypes != "null") {
                ...
                // 获取列表数据
            http.request('gongnuanList/list', 'get', param, function(res) {
