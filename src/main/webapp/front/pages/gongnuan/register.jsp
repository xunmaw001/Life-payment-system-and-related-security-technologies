              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">供暖编号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="gongnuanNumber" id="gongnuanNumber"  placeholder="供暖编号"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">供暖余额:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="gongnuanMoney" id="gongnuanMoney"  lay-verify="double|required"   placeholder="供暖余额" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">供暖编号所在地址:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="gongnuanAddress" id="gongnuanAddress"  placeholder="供暖编号所在地址"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
