            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">宽带缴费记录展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="kuandaiListNewMoneyStart" id="kuandaiListNewMoneyStart"  lay-skin="double"   placeholder="缴费金额(元)开始" autocomplete="off" class="layui-input">
                              -
                              <input type="text" name="kuandaiListNewMoneyend"   id="kuandaiListNewMoneyend"    lay-skin="double|kuandaiListNewMoneyend"   placeholder="缴费金额(元)结束" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 kuandaiListContent 字段去除无用字符 如果字段长度大于60  就截取到60
            kuandaiListContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        form.verify({
            ...
            ,kuandaiListNewMoneyend: function(value, item){ //value：表单的值、item：表单的DOM对象
                var kuandaiListNewMoneyStart = $("#kuandaiListNewMoneyStart").val();
                if(kuandaiListNewMoneyStart != null && kuandaiListNewMoneyStart != "" && kuandaiListNewMoneyStart != "null"){
                    var number = parseInt(value)- parseInt(kuandaiListNewMoneyStart);
                    if(number<0){
        ...
        function pageList() {
            ...
            if (jquery('#kuandaiListNewMoneyStart').val() != null && jquery('#kuandaiListNewMoneyStart').val() != "" && jquery('#kuandaiListNewMoneyStart').val() != "null" ) {
                param['kuandaiListNewMoneyStart'] = jquery('#kuandaiListNewMoneyStart').val();
            }
            if (jquery('#kuandaiListNewMoneyEnd').val() != null && jquery('#kuandaiListNewMoneyEnd').val() != "" && jquery('#kuandaiListNewMoneyEnd').val() != "null" ) {
                param['kuandaiListNewMoneyEnd'] = jquery('#kuandaiListNewMoneyEnd').val();
            }
            ...
            if (successTypes != null && successTypes != "" && successTypes != "null") {
                ...
                // 获取列表数据
            http.request('kuandaiList/list', 'get', param, function(res) {
