            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">油卡缴费记录展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="youkaListNewMoneyStart" id="youkaListNewMoneyStart"  lay-skin="double"   placeholder="缴费金额(元)开始" autocomplete="off" class="layui-input">
                              -
                              <input type="text" name="youkaListNewMoneyend"   id="youkaListNewMoneyend"    lay-skin="double|youkaListNewMoneyend"   placeholder="缴费金额(元)结束" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 youkaListContent 字段去除无用字符 如果字段长度大于60  就截取到60
            youkaListContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        form.verify({
            ...
            ,youkaListNewMoneyend: function(value, item){ //value：表单的值、item：表单的DOM对象
                var youkaListNewMoneyStart = $("#youkaListNewMoneyStart").val();
                if(youkaListNewMoneyStart != null && youkaListNewMoneyStart != "" && youkaListNewMoneyStart != "null"){
                    var number = parseInt(value)- parseInt(youkaListNewMoneyStart);
                    if(number<0){
        ...
        function pageList() {
            ...
            if (jquery('#youkaListNewMoneyStart').val() != null && jquery('#youkaListNewMoneyStart').val() != "" && jquery('#youkaListNewMoneyStart').val() != "null" ) {
                param['youkaListNewMoneyStart'] = jquery('#youkaListNewMoneyStart').val();
            }
            if (jquery('#youkaListNewMoneyEnd').val() != null && jquery('#youkaListNewMoneyEnd').val() != "" && jquery('#youkaListNewMoneyEnd').val() != "null" ) {
                param['youkaListNewMoneyEnd'] = jquery('#youkaListNewMoneyEnd').val();
            }
            ...
            if (successTypes != null && successTypes != "" && successTypes != "null") {
                ...
                // 获取列表数据
            http.request('youkaList/list', 'get', param, function(res) {
