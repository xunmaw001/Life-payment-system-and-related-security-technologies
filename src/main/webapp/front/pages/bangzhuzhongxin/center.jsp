	...
	<body style="background: #EEEEEE;">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="bangzhuzhongxinName" id="bangzhuzhongxinName" lay-verify="required" placeholder="名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="bangzhuzhongxinTypes" id="bangzhuzhongxinTypes">
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="bangzhuzhongxinPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="bangzhuzhongxinPhoto" name="bangzhuzhongxinPhoto"/>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload'], function () {
                ...
                http.request(`bangzhuzhongxin/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#bangzhuzhongxinPhotoImg").attr("src", data.data.bangzhuzhongxinPhoto);
                });
