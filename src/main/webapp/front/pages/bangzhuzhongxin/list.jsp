            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">帮助中心展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="bangzhuzhongxinName" id="bangzhuzhongxinName" placeholder="名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                        ...
                        <div class="article-list">
                            <ul class="after">
                                <li v-for="(item,index) in dataList" v-bind:key="index">
                                    <a target="_self" :href="'../bangzhuzhongxin/detail.jsp?id='+item.id">
                                        <img width="180" class="fl" :src="item.bangzhuzhongxinPhoto" />
                                        <h5>{{item.bangzhuzhongxinName}}</h5>
                                        <p class="time-sour">
                                            <span>发布时间：{{item.insertTime}} </span>
                                        </p>
                                        <p class="reamk">{{item.bangzhuzhongxinContent|bangzhuzhongxinContent}}...</p>
                                    </a>
                                </li>
                            </ul>
                            <div class="pages">
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 bangzhuzhongxinContent 字段去除无用字符 如果字段长度大于60  就截取到60
            bangzhuzhongxinContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#bangzhuzhongxinName').val() != null && jquery('#bangzhuzhongxinName').val() != "" && jquery('#bangzhuzhongxinName').val() != "null" ) {
                param['bangzhuzhongxinName'] = jquery('#bangzhuzhongxinName').val();
            }
     
            var bangzhuzhongxinTypes = $("#bangzhuzhongxinTypes").find("option:selected").val();
            if (bangzhuzhongxinTypes != null && bangzhuzhongxinTypes != "" && bangzhuzhongxinTypes != "null") {
                param['bangzhuzhongxinTypes'] = bangzhuzhongxinTypes;
            }
                            // 获取列表数据
            http.request('bangzhuzhongxin/list', 'get', param, function(res) {
...
// 当前表的字典表
       ...
       function bangzhuzhongxinTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=bangzhuzhongxin_types", 'get', {}, function (res) {
               if(res.code == 0){
