              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">ETC编号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="etcNumber" id="etcNumber"  placeholder="ETC编号"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">ETC余额:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="etcMoney" id="etcMoney"  lay-verify="double|required"   placeholder="ETC余额" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">ETC编号所在地址:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="etcAddress" id="etcAddress"  placeholder="ETC编号所在地址"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
