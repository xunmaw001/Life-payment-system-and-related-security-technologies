            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">固话缴费记录展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="guhuaListNewMoneyStart" id="guhuaListNewMoneyStart"  lay-skin="double"   placeholder="缴费金额(元)开始" autocomplete="off" class="layui-input">
                              -
                              <input type="text" name="guhuaListNewMoneyend"   id="guhuaListNewMoneyend"    lay-skin="double|guhuaListNewMoneyend"   placeholder="缴费金额(元)结束" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 guhuaListContent 字段去除无用字符 如果字段长度大于60  就截取到60
            guhuaListContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        form.verify({
            ...
            ,guhuaListNewMoneyend: function(value, item){ //value：表单的值、item：表单的DOM对象
                var guhuaListNewMoneyStart = $("#guhuaListNewMoneyStart").val();
                if(guhuaListNewMoneyStart != null && guhuaListNewMoneyStart != "" && guhuaListNewMoneyStart != "null"){
                    var number = parseInt(value)- parseInt(guhuaListNewMoneyStart);
                    if(number<0){
        ...
        function pageList() {
            ...
            if (jquery('#guhuaListNewMoneyStart').val() != null && jquery('#guhuaListNewMoneyStart').val() != "" && jquery('#guhuaListNewMoneyStart').val() != "null" ) {
                param['guhuaListNewMoneyStart'] = jquery('#guhuaListNewMoneyStart').val();
            }
            if (jquery('#guhuaListNewMoneyEnd').val() != null && jquery('#guhuaListNewMoneyEnd').val() != "" && jquery('#guhuaListNewMoneyEnd').val() != "null" ) {
                param['guhuaListNewMoneyEnd'] = jquery('#guhuaListNewMoneyEnd').val();
            }
            ...
            if (successTypes != null && successTypes != "" && successTypes != "null") {
                ...
                // 获取列表数据
            http.request('guhuaList/list', 'get', param, function(res) {
