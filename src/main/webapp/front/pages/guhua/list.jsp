            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">固话展示</span>
                ...
                <fieldset class="search-container" style="text-align: center;">
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">固话编号</label>
                          <div class="layui-input-inline">
                              <input type="text" name="guhuaNumber" id="guhuaNumber" placeholder="固话编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
     
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">固话余额</label>
                          <div class="layui-input-inline">
                              <input type="text" name="guhuaMoneyStart" id="guhuaMoneyStart"  lay-skin="double"   placeholder="固话余额开始" autocomplete="off" class="layui-input">
                              -
                              <input type="text" name="guhuaMoneyend"   id="guhuaMoneyend"    lay-skin="double|guhuaMoneyend"   placeholder="固话余额结束" autocomplete="off" class="layui-input">
                          </div>
                      </div>
     
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">固话编号所在地址</label>
                          <div class="layui-input-inline">
                              <input type="text" name="guhuaAddress" id="guhuaAddress" placeholder="固话编号所在地址" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 guhuaContent 字段去除无用字符 如果字段长度大于60  就截取到60
            guhuaContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        form.verify({
            ...
            ,guhuaMoneyend: function(value, item){ //value：表单的值、item：表单的DOM对象
                var guhuaMoneyStart = $("#guhuaMoneyStart").val();
                if(guhuaMoneyStart != null && guhuaMoneyStart != "" && guhuaMoneyStart != "null"){
                    var number = parseInt(value)- parseInt(guhuaMoneyStart);
                    if(number<0){
                        return '固话余额的结束值不能小于开始值';
                    }
                }
            }
        ...
        function pageList() {
            ...
            if (jquery('#guhuaNumber').val() != null && jquery('#guhuaNumber').val() != "" && jquery('#guhuaNumber').val() != "null" ) {
                param['guhuaNumber'] = jquery('#guhuaNumber').val();
            }
     
            if (jquery('#guhuaMoneyStart').val() != null && jquery('#guhuaMoneyStart').val() != "" && jquery('#guhuaMoneyStart').val() != "null" ) {
                param['guhuaMoneyStart'] = jquery('#guhuaMoneyStart').val();
            }
            if (jquery('#guhuaMoneyEnd').val() != null && jquery('#guhuaMoneyEnd').val() != "" && jquery('#guhuaMoneyEnd').val() != "null" ) {
                param['guhuaMoneyEnd'] = jquery('#guhuaMoneyEnd').val();
            }
     
            if (jquery('#guhuaAddress').val() != null && jquery('#guhuaAddress').val() != "" && jquery('#guhuaAddress').val() != "null" ) {
                param['guhuaAddress'] = jquery('#guhuaAddress').val();
            }
                // 获取列表数据
            http.request('guhua/list', 'get', param, function(res) {
