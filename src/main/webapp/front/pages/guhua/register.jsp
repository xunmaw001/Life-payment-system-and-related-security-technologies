              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">固话编号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="guhuaNumber" id="guhuaNumber"  placeholder="固话编号"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">固话余额:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="guhuaMoney" id="guhuaMoney"  lay-verify="double|required"   placeholder="固话余额" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">固话编号所在地址:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="guhuaAddress" id="guhuaAddress"  placeholder="固话编号所在地址"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
