                ...
                <fieldset class="search-container" style="text-align: center;">
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="newMoneyStart" id="newMoneyStart"  lay-skin="double"   placeholder="余额开始" autocomplete="off" class="layui-input">
                              -
                              <input type="text" name="newMoneyend"   id="newMoneyend"    lay-skin="double|newMoneyend"   placeholder="余额结束" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        form.verify({
            ...
            ,newMoneyend: function(value, item){ //value：表单的值、item：表单的DOM对象
                var newMoneyStart = $("#newMoneyStart").val();
                if(newMoneyStart != null && newMoneyStart != "" && newMoneyStart != "null"){
                    var number = parseInt(value)- parseInt(newMoneyStart);
                    if(number<0){
                        return '余额的结束值不能小于开始值';
                    }
                }
            }
        ...
        function pageList() {
            ...
            if (jquery('#newMoneyStart').val() != null && jquery('#newMoneyStart').val() != "" && jquery('#newMoneyStart').val() != "null" ) {
                param['newMoneyStart'] = jquery('#newMoneyStart').val();
            }
            if (jquery('#newMoneyEnd').val() != null && jquery('#newMoneyEnd').val() != "" && jquery('#newMoneyEnd').val() != "null" ) {
                param['newMoneyEnd'] = jquery('#newMoneyEnd').val();
            }
                // 获取列表数据
