            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">水表缴费记录展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="shuibiaoListNewMoneyStart" id="shuibiaoListNewMoneyStart"  lay-skin="double"   placeholder="缴费金额(元)开始" autocomplete="off" class="layui-input">
                              -
                              <input type="text" name="shuibiaoListNewMoneyend"   id="shuibiaoListNewMoneyend"    lay-skin="double|shuibiaoListNewMoneyend"   placeholder="缴费金额(元)结束" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 shuibiaoListContent 字段去除无用字符 如果字段长度大于60  就截取到60
            shuibiaoListContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        form.verify({
            ...
            ,shuibiaoListNewMoneyend: function(value, item){ //value：表单的值、item：表单的DOM对象
                var shuibiaoListNewMoneyStart = $("#shuibiaoListNewMoneyStart").val();
                if(shuibiaoListNewMoneyStart != null && shuibiaoListNewMoneyStart != "" && shuibiaoListNewMoneyStart != "null"){
                    var number = parseInt(value)- parseInt(shuibiaoListNewMoneyStart);
                    if(number<0){
        ...
        function pageList() {
            ...
            if (jquery('#shuibiaoListNewMoneyStart').val() != null && jquery('#shuibiaoListNewMoneyStart').val() != "" && jquery('#shuibiaoListNewMoneyStart').val() != "null" ) {
                param['shuibiaoListNewMoneyStart'] = jquery('#shuibiaoListNewMoneyStart').val();
            }
            if (jquery('#shuibiaoListNewMoneyEnd').val() != null && jquery('#shuibiaoListNewMoneyEnd').val() != "" && jquery('#shuibiaoListNewMoneyEnd').val() != "null" ) {
                param['shuibiaoListNewMoneyEnd'] = jquery('#shuibiaoListNewMoneyEnd').val();
            }
            ...
            if (successTypes != null && successTypes != "" && successTypes != "null") {
                ...
                // 获取列表数据
            http.request('shuibiaoList/list', 'get', param, function(res) {
