            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">电表缴费记录展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="dianbiaoListNewMoneyStart" id="dianbiaoListNewMoneyStart"  lay-skin="double"   placeholder="缴费金额(元)开始" autocomplete="off" class="layui-input">
                              -
                              <input type="text" name="dianbiaoListNewMoneyend"   id="dianbiaoListNewMoneyend"    lay-skin="double|dianbiaoListNewMoneyend"   placeholder="缴费金额(元)结束" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 dianbiaoListContent 字段去除无用字符 如果字段长度大于60  就截取到60
            dianbiaoListContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        form.verify({
            ...
            ,dianbiaoListNewMoneyend: function(value, item){ //value：表单的值、item：表单的DOM对象
                var dianbiaoListNewMoneyStart = $("#dianbiaoListNewMoneyStart").val();
                if(dianbiaoListNewMoneyStart != null && dianbiaoListNewMoneyStart != "" && dianbiaoListNewMoneyStart != "null"){
                    var number = parseInt(value)- parseInt(dianbiaoListNewMoneyStart);
                    if(number<0){
        ...
        function pageList() {
            ...
            if (jquery('#dianbiaoListNewMoneyStart').val() != null && jquery('#dianbiaoListNewMoneyStart').val() != "" && jquery('#dianbiaoListNewMoneyStart').val() != "null" ) {
                param['dianbiaoListNewMoneyStart'] = jquery('#dianbiaoListNewMoneyStart').val();
            }
            if (jquery('#dianbiaoListNewMoneyEnd').val() != null && jquery('#dianbiaoListNewMoneyEnd').val() != "" && jquery('#dianbiaoListNewMoneyEnd').val() != "null" ) {
                param['dianbiaoListNewMoneyEnd'] = jquery('#dianbiaoListNewMoneyEnd').val();
            }
            ...
            if (successTypes != null && successTypes != "" && successTypes != "null") {
                ...
                // 获取列表数据
            http.request('dianbiaoList/list', 'get', param, function(res) {
