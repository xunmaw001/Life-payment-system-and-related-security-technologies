              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">水表编号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="shuibiaoNumber" id="shuibiaoNumber"  placeholder="水表编号"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">水表余额:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="shuibiaoMoney" id="shuibiaoMoney"  lay-verify="double|required"   placeholder="水表余额" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">水表编号所在地址:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="shuibiaoAddress" id="shuibiaoAddress"  placeholder="水表编号所在地址"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
